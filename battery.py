...
style.layout('ProgressBarStyle', [{'Horizontal.ProgressBar.trough', ['children':[{'Horizontal.pProgressbay.pbar', ['side':'right', 'sticky':'ns']}], 'sticky':'nsew']}, ['Horizontal.Progressbar.label'], {'sticky': ''}])
...
def getBatteryLife():
    ...
    if battery.secsleft==BatteryTime.POWER_TIME_UNLIMITED:
        battery_life['text']='Unplugged the battery! /n And run the code again'
